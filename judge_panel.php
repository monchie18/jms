...
<?php
  ...
  <div class="container">
            ...
            <div class="alert alert-success">
                ...
                if ($pageStat == "Change") {
                    ...
                    while ($cont_row = $cont_query->fetch()) {
                        echo "<strong>Change Score Panel - " . $cont_row['fullname'] . "</strong>";
                    }
                } else {
                    // Dropdown for contestants
                    ?>
                    <select id="contestantDropdown" class="form-control" onchange="location = this.value;">
    <!-- Add this line for the default option -->
    ...
    ?>
    <option value="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $con_idTab;?>" <?php if($getContestant_id == $con_idTab) echo 'selected'; ?>>
        <?php echo $cont_row['fullname']; ?>
    </option>
    <?php
    }
    ?>
    <option value="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=allTally" <?php if($getContestant_id == "allTally") echo 'selected'; ?>>
        View Tally
    </option>
</select>
...
/>
<button type="reset" class="btn btn-warning">Reset Score</button>
