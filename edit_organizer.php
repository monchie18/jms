...
<div class="container" style="text-align: center;  justify-content: center; align-items: center; ">
 ...
 <div class="panel panel-primary">
   ...
   <?php 
    ...
    <td>
    Email:
    <input type="email" name="email" class="form-control" placeholder="Email" value="<?php echo $row['email']; ?>" aria-describedby="basic-addon1" autofocus>
 </td>
    <td>&nbsp;</td>
    <td>
    Phone Number:
    <input type="text" name="pnum" class="form-control" placeholder="Phone Number" value="<?php echo $row['pnum']; ?>" aria-describedby="basic-addon1"  autofocus>
 </td>
    <td>&nbsp;</td>
    <td>
   </td>
    ...
    <td colspan="5">
    Company Name:
    <input type="text" name="cname" class="form-control" placeholder="Company Name" value="<?php echo $row['company_name']; ?>" aria-describedby="basic-addon1"  autofocus>
 </td>
    </tr>
    ...
    <td colspan="5">
    Company Address:
    <input type="text" name="caddress" class="form-control" placeholder="Company Address" value="<?php echo $row['company_address']; ?>" aria-describedby="basic-addon1"  autofocus>
 </td>
    </tr>
    ...
    <td>
    Telephone:
    <input type="text" name="ctelephone" class="form-control" placeholder="Company Telephone" value="<?php echo $row['company_telephone']; ?>" aria-describedby="basic-addon1"  autofocus>
 </td>
    <td>&nbsp;</td>
    <td>
    Email:
    <input type="text" name="cemail" class="form-control" placeholder="Company Email" value="<?php echo $row['company_email']; ?>" aria-describedby="basic-addon1"  autofocus>
 </td>
    <td>&nbsp;</td>
    <td>
    Website:
    <input type="text" name="cwebsite" class="form-control" placeholder="Company Website" value="<?php echo $row['company_website']; ?>" aria-describedby="basic-addon1"  autofocus>
 </td>
    </tr>
